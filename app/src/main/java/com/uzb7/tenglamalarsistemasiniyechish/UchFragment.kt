...
import com.uzb7.tenglamalarsistemasiniyechish.databinding.FragmentUchBinding
import com.uzb7.tenglamalarsistemasiniyechish.utils.viewBinding


class UchFragment : Fragment(R.layout.fragment_uch) {

    private val binding by viewBinding { FragmentUchBinding.bind(it) }
    ...
    private fun initViews() {
        binding.apply {
            ivBack.setOnClickListener{
                findNavController().navigate(R.id.action_uchFragment_to_homeFragment)
            }
